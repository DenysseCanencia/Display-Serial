 ...
 *
 *Nombre: Display Serial 
 *
 *Descripcion: Practica que utiliza una pantalla LCD para mostrar una serie de mensajes
 que seran enviados desde una interfaz realizada en java,tammbien en la pantalla se 
 mostrara la temperatura para lo cual que se utilza un sensor de temperatura LM35, 
...
//Incluimos las librerias tanto para el RTC como para el LCD
#include <DS1302.h>
